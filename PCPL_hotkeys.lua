--[[
      OBS Studio Lua script : Control the PCPL ScoreBoard with hotkeys
--]]
...
local hotkeys = {
	P1_SCR_UP = "PCPL - Player 1 Score +1",
	P1_SCR_DOWN = "PCPL - Player 1 Score -1",
	P2_SCR_UP = "PCPL - Player 2 Score +1",
	P2_SCR_DOWN = "PCPL - Player 2 Score -1",
	SCR_RESET = "PCPL - Score Reset",
	P1_EXT = "PCPL - Player 1 Extension",
	P2_EXT = "PCPL - Player 2 Extension",
	CLOCK_30 = "PCPL - 30 Second Shot Clock Start",
	CLOCK_60 = "PCPL - 60 Second Shot Clock Start",
	STOP_CLK = "PCPL - Stop Clock",
	SWAP_CLR = "PCPL - Swap Player Colors",
...
function script_description()
	return "Control the PCPL ScoreBoard with hotkeys"
end
